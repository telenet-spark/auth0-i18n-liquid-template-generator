            ...
            <td>
                <div
                    ...
                    <h1 style="font-size: 32px; font-weight: 600; line-height: 38px; color: white; margin-bottom: 0px;">
                        <span class="font" style="font-family:verdana, sans-serif">${localizeMessage("email-verification.title")}<br></span>
                    </h1>
                </div>
            </td>
        </tr>
            ...
            <td>
                <div
                    ...
                    <h3 style="font-size: 20px; font-weight: 600; line-height: 20px;">
                        <span class="font" style="font-family:verdana, sans-serif">${localizeMessage("email-verification.content.title")}<br></span>
                    </h3>
                    <p style="line-height: 24px; margin-bottom: 30px;">
                        <span class="size" style="font-size: 14px; line-height: 24px; margin-bottom: 30px;"><span class="font" style="font-family:verdana, sans-serif">${localizeMessage("email-verification.content.description")}</span></span><span class="font" style="font-family:verdana, sans-serif"><br></span>
                    </p><a href="{{ url }}"
                        style="font-size: 14px; color: #DCF730; cursor: pointer; line-height: normal; text-align: center; text-decoration: none; cursor: pointer; padding: 14px 18px; background-color: #12292F; border-radius: 6px; display: inline-block; margin-bottom: 10px;"><span class="font" style="font-family:verdana, sans-serif">${localizeMessage("email-verification.content.submit")}</span></a><span class="font" style="font-family:verdana, sans-serif"> </span>
                </div>
            </td>
        </tr>
        <tr style="background-color: #fff;">
